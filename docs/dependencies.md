...
The OpenOrbis source at the pinned revision was separately downloaded as an archive. The archive is a source snapshot, without Git history or prebuilt release binaries. To recreate it from GitHub:

```sh
git clone https://github.com/OpenOrbis/OpenOrbis-PS4-Toolchain.git
git -C OpenOrbis-PS4-Toolchain checkout 0a1aaf9dd4a92695538bdeb09fb056d06dd11725
```
